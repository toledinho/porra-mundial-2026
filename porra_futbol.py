...
def crear_excel(participantes, resultados_reales, nombres_partidos, archivo_salida='porra_futbol.xlsx', exportar_imagen=True):
    ...
    if exportar_imagen:
        ...
        with PdfPages(pdf_filename) as pdf:
            ...
            # Ajustar el título
            plt.title('Clasificación Porra de Fútbol - Jornada 1', fontsize=16, pad=20)
...
def main():
    ...
    datos_brutos = """
    PITU 1-4 2-2 1-1
    PEPE SÁNCHEZ 1-5 1-1 2-1
    CARTERO 2-4 1-1 2-1
    P. PULMONE 1-3 1-1 0-0
    PATITO YEDRA 0-3 1-2 0-2
    GREGORIO 0-4 2-0 1-3
    ALVARO 1-4 1-1 1-2
    MANU MASTANTUONO 1-4 1-1 1-1
    YAREMA 1-3 1-1 2-1
    FRANCIS PITU 0-3 1-1 1-2
    BICHO 0-3 1-0 0-2
    DAVID ROMERO 1-3 2-0 1-2
    KIKO 0-2 1-1 0-2
    ANA KIKO 1-4 0-1 1-3
    PAQUITO FERNÁNDEZ 1-3 2-0 1-2
    ANTONIO ARMARIO 1-2 2-0 1-2
    TATIANA 1-3 0-1 0-2
    JAIME 0-4 1-0 0-2
    TOLEDINHO 0-4 0-2 1-1
    MARGAFLOWER 0-2 1-0 1-2
    LOURDES MASTANTUONO 0-3 0-0 1-3
    VIRGINIA (ALVARO) 0-3 1-0 0-1
    MIGUEL COLORADO 1-3 1-1 0-2
    JOSE CASTAÑO 1-4 2-1 1-2
    ANTOÑITO CASTAÑO 0-3 2-1 1-2
    VEGALILEO 0-3 0-0 0-1
    TUTIO 1-3 1-1 0-2
    CRISTIAN 2-4 1-1 0-2
    MUITO 0-3 0-0 1-2
    PEDRO ROBLEDO 0-4 2-0 1-3
    GARAY 1-3 1-2 2-2
    JUANPE 1-2 1-0 1-1
    JOSAN 0-3 0-0 1-3
    PELI PATITO 1-3 1-0 0-2
    SEÑOR PATO 1-3 2-0 1-2
    ANA TERESA ROBALO 1-3 1-1 1-2
    GOMINAS SCARIOLO 1-2 2-1 1-1
    RUZ 1-3 2-1 1-2
    YORYO 0-1 0-2 0-1
    PIRATA 0-2 1-2 0-2
    MARIOMF 1-4 1-0 1-3
    MORACO 1-3 1-1 1-2
    JUANITO VIAS 0-3 3-1 0-2
    NINI 1-2 0-0 1-3
    VALLES 0-3 1-0 1-1
    FRANCISCO ARMARIO 0-3 2-1 1-3
    JESUS G. 1-3 2-0 1-3
    OSCAR ROBALO 0-4 3-0 0-4
    SANTI ROBALO 0-2 1-1 0-2
    JOSE GÜLER 1-3 0-2 0-2
    SANTI (CON VISTAS) 1-5 0-2 1-3
    PEPOTE 1-3 1-0 0-2
    MASON 1-4 2-1 1-2
    """
